      ...
      >
        ...
        <div className="px-6 flex flex-col">
          ...
          <div className="flex items-center justify-between mt-2 gap-4">
            ...
            <button 
              onClick={handleSave}
              className="bg-green-500 hover:bg-green-400 p-4 rounded-2xl flex-shrink-0 transition-all active:scale-[0.95] shadow-lg shadow-green-500/20 flex items-center justify-center z-10"
            >
