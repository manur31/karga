...
const QuestionIcon = ({ className }) => ( //despues lo paso a icons, me dio paja
...
export default function WorkoutModal({ onClose }) {
  ...
  const handleSaveRoutine = () => {
    console.log("Guardando rutina:", { nombre: routineName, ejercicios: selectedExercises });
    onClose();
  };
  ...
  return (
    ...
    <div className="fixed top-0 bottom-[76px] left-1/2 -translate-x-1/2 w-full max-w-md z-40 flex flex-col bg-[var(--color-dark-bg)] transition-all duration-300 ease-out animate-in fade-in slide-in-from-bottom-5">
      ...
      <div className="flex-1 overflow-y-auto p-5 pb-32 flex flex-col gap-6 [scrollbar-width:none] [&::-webkit-scrollbar]:none z-10">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input 
            ...
            className="bg-[var(--color-karga-gray)] border border-transparent rounded-2xl p-4 text-white placeholder:text-zinc-500 focus:outline-none focus:border-karga-orange transition-colors font-medium shadow-inner"
          />
        </div>
      ...
      <div className="absolute bottom-[-1px] inset-x-0 p-5 pb-0 pt-12 bg-gradient-to-t from-[var(--color-dark-bg)] via-[var(--color-dark-bg)] to-transparent z-30">
        <button
          type="button"
